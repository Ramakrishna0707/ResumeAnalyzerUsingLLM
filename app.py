...
def load_api_key():
    load_dotenv()
    openai.api_key = os.getenv('OPEN_API_KEY') #Replace it with your OpenAI api key
...
def define_prompts():
    ...
    resume_modification_prompt = PromptTemplate(
        ...
        {job_description}. Incorporate relevant keywords, add missing keywords from job description, change the summary and highlight the candidate's skills and experiences that matches the job requirements. Maintain the 
